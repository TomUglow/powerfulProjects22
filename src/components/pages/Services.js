    ...
    return(
        ...
        <div className='services'>
            ...
            <div className='services-box-domestic'>
                <h1 className='services-box-heading'>DOMESTIC</h1>
                <br></br>
                <p className='services-box-text'>
                    ...
                    We excel in fault finding, service &amp; maintenance; whatever the job, we have all the tools and experience to deliver a first class finish.
                </p>
            </div>
        </div>
        </>
